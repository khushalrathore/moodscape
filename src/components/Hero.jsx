      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[90px] mb-2">
          ...
          <p className={`${styles.paragraph} ml-2`}>
            <span className="text-white">30%</span> <span className="text-orange-100"> Off For{" "} </span>
            <span className="text-white">New</span> <span className="text-orange-100"> User{" "} </span>
          </p>
        </div>
